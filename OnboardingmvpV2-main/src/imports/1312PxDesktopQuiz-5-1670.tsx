import svgPaths from "./svg-dtvtyw0q2p";
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Question Text Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[20px] text-white w-full">
        <p className="leading-[1.3] whitespace-pre-wrap">Quantos anos você tem?</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-center min-h-px min-w-px relative">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#a4a4a4] text-[16px] whitespace-nowrap">
        <p className="leading-none">Idade</p>
      </div>
    </div>
  );
}

function QuestionTextContainer1() {
  return (
    <div className="content-stretch flex flex-col items-start min-w-[320px] relative shrink-0 w-[320px]" data-name="Question Text Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#a4a4a4] text-[0px] w-full">
        <p className="text-[14px] whitespace-pre-wrap">
          <span className="leading-[1.3]">{`Informar a sua idade garante que você tenha a experiência certa na Overlens. Para saber mais, acesse a nossa `}</span>
          <span className="[text-decoration-skip-ink:none] decoration-solid font-['Inter:Bold',sans-serif] font-bold leading-[1.3] not-italic underline">Política de Privacidade.</span>
        </p>
      </div>
    </div>
  );
...
function DescriptionContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0" data-name="Description Container">
...
function InputFieldContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0" data-name="Input Field Container">
...
function DividerContainer() {
  return (
    <div className="relative shrink-0 w-full" data-name="Divider Container">
...
function GoogleTextContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Google Text Container">
