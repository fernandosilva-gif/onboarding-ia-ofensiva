import svgPaths from "./svg-meskguniz8";
import { imgCheck } from "./svg-i0ykh";
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[660px]" data-name="Question Text Container">
      <div className="flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[20px] text-white whitespace-nowrap">
        <p className="leading-[1.3]">Eu aprendo melhor quando…</p>
      </div>
    </div>
  );
}
...
function AnswersContainer() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[28px] items-start leading-[0] not-italic relative shrink-0 w-full whitespace-nowrap" data-name="Answers Container">
      <div className="content-stretch flex gap-[8px] items-end relative shrink-0 w-full" data-name="Multipla Escolha">
        ...
        <div className="flex flex-col justify-center relative shrink-0 text-[#a4a4a4] text-[16px]">
          <p className="leading-[12px]">{`alguém mostra exatamente como fazer `}</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-end relative shrink-0 w-full" data-name="Multipla Escolha">
        <div className="flex flex-col justify-center relative shrink-0 text-[20px] text-white">
        ...
        <div className="flex flex-col justify-center relative shrink-0 text-[#a4a4a4] text-[16px]">
          <p className="leading-[12px]">existe um método claro para seguir</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-end relative shrink-0 w-full" data-name="Multipla Escolha">
        <div className="flex flex-col justify-center relative shrink-0 text-[20px] text-white">
        ...
        <div className="flex flex-col justify-center relative shrink-0 text-[#a4a4a4] text-[16px]">
          <p className="leading-[12px]">posso analisar casos reais</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-end relative shrink-0 w-full" data-name="Multipla Escolha">
        <div className="flex flex-col justify-center relative shrink-0 text-[20px] text-white">
        ...
        <div className="flex flex-col justify-center relative shrink-0 text-[#a4a4a4] text-[16px]">
          <p className="leading-[12px]">preciso testar várias hipóteses</p>
        </div>
      </div>
      <div className="content-stretch flex gap-[8px] items-end relative shrink-0 w-full" data-name="Multipla Escolha">
        <div className="flex flex-col justify-center relative shrink-0 text-[20px] text-white">
        ...
        <div className="flex flex-col justify-center relative shrink-0 text-[#a4a4a4] text-[16px]">
          <p className="leading-[12px]">preciso lidar com as consequências</p>
        </div>
      </div>
    </div>
  );
